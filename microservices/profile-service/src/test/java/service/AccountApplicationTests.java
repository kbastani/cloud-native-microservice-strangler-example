...
import demo.ProfileApplication;
...
public class AccountApplicationTests extends TestCase {
    ...
    public void customerTest() {
        ...
        // Create a new com.example.customer for the account
        ...
        // Add the credit card to the com.example.customer's account
        customer.getAccount()
                .getCreditCards()
                .add(creditCard);

        // Create a new shipping address for the com.example.customer
        Address address = new Address("1600 Pennsylvania Ave NW", null,
                "DC", "Washington", "United States", AddressType.SHIPPING, 20500);

        // Add address to the com.example.customer's account
        customer.getAccount()
                .getAddresses()
                .add(address);

        // Apply the cascading update by persisting the com.example.customer object
        customer = customerRepository.save(customer);

        // Query for the com.example.customer object to ensure cascading persistence of the object graph
